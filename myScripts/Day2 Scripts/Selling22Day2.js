...
function OnGUI () {
		...
		if (isButtonCreated4) {
			if(stopSell==false){
	    		...
	    		if(price > 1800){
	    			price = 1800;
	    			priceError3.enabled = true;
	    			priceError3.text = "Maybe you should lower the price, customer is concerned";
	    		}
	    		else if (price > 800){
	...
	if(stopSell == false){	
		if (isButtonCreated5) {
			...
			{
				priceError3.enabled = true;
				textHints.text = "I'm sorry that's too expensive";
...
//	        	PlayerPrefs.SetInt("Gold", tempGoldNo); 
        		...
        		priceError3.enabled = false;
        		textHints.text = "Thank you! I'll come back soon for more items ";
