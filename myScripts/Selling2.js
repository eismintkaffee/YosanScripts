...
public var buttonTexture : UI.Button;
...
var addButtonTextuteHover : Texture;
...
//sounds
 ...
 function Start(){
	...
	// Setting the Day1SaleMade variable to 0 otherwise the game will just advance
	// without the sale being made
	PlayerPrefs.SetInt("Day1SaleMade", 0);
		...
		if (isButtonCreated5) {
			...
			else if (price > 550)
			{
        		...
        		if (stopSell == false){
	        		...
	        		PlayerPrefs.SetInt("Day1SaleMade", 1);
        		}
        		buttonS = "Exit";
        	}
